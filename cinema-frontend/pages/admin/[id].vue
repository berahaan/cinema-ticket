<template>
    <div class="min-h-screen bg-gray-100">
      <div v-if="loading" class="text-center text-gray-600 py-10">Loading movie details...</div>
      <div v-else-if="error" class="text-center text-red-600 py-10">Error: {{ error.message }}</div>
      <div v-else class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
        ...
        <div class="flex flex-col md:flex-row gap-6">
          ...
          <div class="flex-1">
            ...
            <p class="mt-4 text-gray-600">
              <strong>Average Rating:</strong> {{ movie.average_rating?.average_rating || 'Not Rated' }}
            </p>
          </div>
        </div>
          ...
          <table class="w-full border-collapse border border-gray-300 mt-4">
            ...
            <tbody>
              ...
              >
                ...
                <td class="border border-gray-300 px-4 py-2">{{ schedule.cinema_hall }}</td>
