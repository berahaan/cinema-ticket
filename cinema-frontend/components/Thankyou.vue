...
const downloadTicket = async () => {
  ...
  try {
    ...
    console.log("Here response for DownloadTicket ",data.downloadTicket);
  ...
  >
    <div class="shadow-md rounded-lg max-w-4xl p-6" :class="selectClass">
      <div class="flex items-center mx-24">
        <h1 v-if="ticketFound" class="text-2xl font-semibold text-green-600">🎉 Thank You For purchase!</h1>
      </div>
      <!-- Payment Status Messages -->
      <div v-if="noticket" class="text-center">
        <p class="text-red-500">
          Unfortunately, your ticket is not valid or the payment was unsuccessful. Please try again.
        </p>
      </div>
     ...
     <ArrowDownIcon class="h-5 w-5 mr-2" />
      ...
      >
        ...
        <span>Back Home</span>
          ...
          <p class=" mt-2">
            You have successfully ordered your ticket. Here are your payment details:
          </p>
        </div>
         
          <h2 class="text-lg font-medium border-b pb-2 mb-4">🎫 Ticket Information</h2>
          <div class="space-y-3">
            <!-- Ticket Details -->
            <div class="flex justify-between">
          ...
          <div class="space-y-3">
            <ul class="space-y-2">
              <h2 class="text-lg font-medium border-b pb-2 mb-4 mt-6">🗓️ You bought Schedule for</h2>
          ...
          <p>Please make yourself available before deadlines and download This ticket </p>
